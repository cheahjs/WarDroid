...
public final class UnifiedPreferenceUtils {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ColorPickerPreference || preference instanceof MultiSelectListPreference)
                return true;
    ...
    public static void bindAllPreferenceSummariesToValues(PreferenceScreen screen) {
        ArrayList<Preference> list = getPreferenceList(screen, new ArrayList<Preference>());
        Map<String, ?> prefs = screen.getSharedPreferences().getAll();
        for (int i = 0; i < list.size(); i++) {
            Preference preference = list.get(i);
            Object value = prefs.get(preference.getKey());
